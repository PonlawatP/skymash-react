...
export default function ProfileItem(props:any) {
    ...
    return <div className="mt-4 rounded-xl drop-shadow-md flex flex-col sm:flex-row gap-10 justify-between items-center w-[66em] p-4 px-6 bg-white">
                <Link to={`/profile/${username}`} className="flex items-center gap-10">
                    <img src={img} onError={(e:any)=>{e.target.src="https://cdn-icons-png.freepik.com/512/3135/3135715.png"}} alt={username} width={120} height={120} className='rounded-full aspect-square object-cover border-2 border-white/30'></img>
